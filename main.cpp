...
Plane planes[] = {
    {Vec3f(-1, -1, 4), Vec3f(0, 2, -0.125).normalize(), Vec3f(1, 0.4, 0)},
    {Vec3f(-1, -1, 4), Vec3f(2, 0, -0.125).normalize(), Vec3f(0.4, 0, 0)},
};

Sphere spheres[] = {
    {Vec3f(0, 0, 2), 1, Vec3f(0.4, 1, 0)},
    {Vec3f(-.4, 2, 2), .6, Vec3f(1, 0, 0.5)},
};
